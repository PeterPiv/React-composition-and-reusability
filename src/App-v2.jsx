...
function Search({ query, setQuery }) {
  // how NOT to select a DOM element within React
  // useEffect(function () {
...
function MovieDetails({ selectedId, onCloseMovie, onAddWatched, watched }) {
  ...
  const { Title: title, Year: year, Poster: poster, Runtime: runtime, imdbRating, Plot: plot, Released: released, Acots: actors, Director: director, Genre: genre } = movie;

  // these two lines are just for educational purposes. dont use them
  ...
  function handleAdd() {
    ...
    // these 2 lines are just for the course
